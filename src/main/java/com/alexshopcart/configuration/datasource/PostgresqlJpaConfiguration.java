package com.alexshopcart.configuration.datasource;
...
@EnableJpaRepositories(basePackages = {"com.alexshopcart" }, 
...
public class PostgresqlJpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean postgressqlEntityManagerFactory(
		...
		return builder.dataSource(dataSource).properties(props).packages("com.alexshopcart").build();
	}
