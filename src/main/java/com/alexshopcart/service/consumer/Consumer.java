...
public interface Consumer {
	...
	<T> Mono<T> getOneByQueryString(MultiValueMap<String, String> request, String baseUrl, String url,
			Class<T> response);

	<T> Mono<T> getOneByQueryStringOne(String baseUrl, String url, Class<T> response);

	Mono<List<ResponseFakeStoreApiDto>> getOneByQueryStringList(String baseUrl, String url);

	<T> Flux<T> getAnyByQueryString(MultiValueMap<String, String> request, String baseUrl, String url,
			Class<T> response);
